...
let rec rename_exp rename = function
  ...
  | SIfLE (id_t1, id_t2, t1, t2) -> SIfLE (rename id_t1, rename_id_or_imm rename id_t2, rename_t rename t1, rename_t rename t2)
  | IfGE (id_t1, id_t2, t1, t2) -> IfGE (rename id_t1, rename_id_or_imm rename id_t2, rename_t rename t1, rename_t rename t2)
  | SIfGE (id_t1, id_t2, t1, t2) -> SIfGE (rename id_t1, rename_id_or_imm rename id_t2, rename_t rename t1, rename_t rename t2)
